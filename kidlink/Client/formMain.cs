    ...
    public partial class formMain : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                clientSocket.Connect(new IPEndPoint(ipAdd, 5000));

                readData = "Servera Bağlanıldı ";
                msg();
        ...
        private void getMessage()
        {
            try
            {
                while (true)
                {
                    ...
                    {
                        MessageBox.Show("Bağlantınız keseildi.");
                        ctThread.Abort();
                        clientSocket.Close();
                        btnConnect.Enabled = true;
                    }
        ...
        {
            DialogResult dialog = MessageBox.Show("Çıkmak istiyor musunuz? ", "Çıkış", MessageBoxButtons.YesNo);
        ...
        public void managePrivateChat(List<string> parts)
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                if (parts[3].Equals("new"))
                {
                    ...
                    privateC.Text = "Özel sohbet " + parts[2];
                    privateC.Show();
                }
                else
                {
        ...
        private void privateChatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listBox1.SelectedIndex != -1)
            {
                ...
                privateChat.Text = "Özel sohbet " + clientName;
                privateChat.Show();
                chat.Clear();
            }
        }
